...
export class RiverPath {
    ...
    getPointAt(z: number): THREE.Vector3 {
    ...
    ensureGeneratedNegative(targetIndex: number) {
    ...
    getRiverBoundarySegments(zCenter: number, range: number): RiverSegment[] {
        const segments = [];
